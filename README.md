...
7. In the `react-proj` directory, run the command `npm start`. This starts a local that runs on port 3000. In Chrome, a page should open at URL `localhost:3000`. If it doesn't open automatically, in Chrome go to the URL `localhost:3000`.
